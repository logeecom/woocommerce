...
<form class="ce-form" onsubmit="return false">
	<div class="ce-extra-data-heading">
		<h3 style="width: 200px"><?php esc_html_e( 'Extra data mapping', 'channelengine-integration' ); ?></h3>
	...
	<div id="hidden" class="ce-input-extra-data last">
		<label>
			...
			<input type="text" class="small-number-input" maxlength="100" minlength="1" placeholder="<?php esc_html_e( 'Enter CE field name', 'channelengine-integration' ); ?>" style="width: 150px"/>
