...
<div class="ce-page">
    <h1><?php echo __( 'Integration status', 'channelengine' ); ?></h1>
    <p>
		<?php echo __( 'Integration between WooCommerce and ChannelEngine is disabled. Synchronization is not performed in the background.', 'channelengine' ); ?>
    </p>
    <div>
        <div class="ce-input-group">
            <label>
                <span class="label"><?php echo __( 'Enable the integration', 'channelengine' ); ?></span>
                <span class="ce-help">
                    <span class="ce-help-tooltip">
                        <?php echo __( 'By enabling integration, you will be asked whether you want to perform full synchronization (products and orders) again since synchronization was disabled for some time.', 'channelengine' ); ?>
                    </span>
                </span>
