    ...
    <main>
        ...
        <div class="ce-page">
            ...
            <table class="ce-table">
                <thead>
                <tr>
                    <td><?php esc_html_e( 'Task Type', 'channelengine-integration' ); ?></td>
                    <td class="text-center"><?php esc_html_e( 'Status', 'channelengine-integration' ); ?></td>
                    <td class="text-center ce-table-compact-view"><?php esc_html_e( 'Details', 'channelengine-integration' ); ?></td>
                    <td class="text-center ce-table-full-view"><?php esc_html_e( 'Start Time', 'channelengine-integration' ); ?></td>
                    <td class="text-center ce-table-full-view"><?php esc_html_e( 'Time Completed', 'channelengine-integration' ); ?></td>
                    <td class="text-center ce-table-full-view"><?php esc_html_e( 'Details', 'channelengine-integration' ); ?></td>
                </tr>
                </thead>
