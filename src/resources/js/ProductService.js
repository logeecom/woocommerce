...
(function () {
    ...
    function ProductService() {
        ...
        let enableStockSynchronizationFields = function () {
            let stockSyncCheckbox = document.getElementById('enableStockSync');
            stockSyncCheckbox.removeAttribute('disabled');
            if (stockSyncCheckbox.checked) {
        ...
        let enableThreeLevelSyncFields = function () {
            ...
            threeLevelSyncStatus.removeAttribute('disabled');
