...
namespace ChannelEngine\Migrations\Utility;
 ...
 *
 * @package ChannelEngine\Migrations\Utility
 */
class Migration_Reader {
    ...
    private function get_class_name( $version ) {
        return 'ChannelEngine\\Migrations\\Scripts\\Migration_' . str_replace( '.', '_', $version );
    }
}